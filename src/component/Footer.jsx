    ...
    return (
        <div>
            <footer class="bg-white dark:bg-gray-900">
                <div class="container p-10 h-[320px] mx-auto">
                    <div class="lg:flex">
                        ...
                        <div class="mt-6 lg:mt-0 lg:flex-1">
                            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                                ...
                                <div>
                                    ...
                                    <span class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">+92 341-9768-520</span>
                                    <span class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">info@webservics.com</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <hr class="h-px my-6 bg-gray-200 border-none dark:bg-gray-700"/>
                        ...
                        <div>
                            <p class="text-center text-gray-500 dark:text-gray-400">© Brand 2020 - All rights reserved Design by Abbas khan</p>
                        </div>
                </div>
            </footer>
        </div>
